        ...
        <div className="grid grid-cols-4 gap-5">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <Link href={`/place/${activity.place}`}>
                    <span className="font-semibold text-sm text-gray-900 flex gap-2">{activity.place} <ClipboardList
            ...
            <div className="flex flex-col space-y-2">
                <span className="font-bold text-md border-b flex items-center gap-2">
                    ...
                    Start Date</span>
                <span className="font-semibold text-sm text-gray-900">{activity.activityDate.toDateString()}</span>
            </div>
            <div className="flex flex-col space-y-2">
                <span className="font-bold text-md border-b flex items-center gap-2">
                    <Clock3 className="h-5 w-5"/>
                    Time</span>
                <span className="font-semibold text-sm text-gray-900">{activity.activityTime}</span>
            </div>
            <div className="flex flex-col space-y-2">
                <span className="font-bold text-md border-b flex items-center gap-2">
                    <Landmark className="h-5 w-5"/>
                    Organizers</span>
                <span className="font-semibold text-sm text-gray-900">{activity.organizers}</span>
            </div>
